...
const TarjetaAves = ({ ave }) => {
  ...
  return (
    <div className="tarjeta-ave-container">
      ...
      >
        {/* Sección de imagen - ahora solo para espaciado */}
        <div className="imagen-section">
        </div>

        {/* Sección de información con fondo verde curvo */}
        <div className="informacion-section">
          ...
          <div className="info-lista">
            ...
            <div className="info-item">
              ...
              <div className="info-content">
                <span className="info-label">Reserva:</span>
                <span className="info-value">{ave.reserva || 'No especificado'}</span>
              </div>
            </div>
